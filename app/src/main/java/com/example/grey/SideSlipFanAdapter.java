...
public class SideSlipFanAdapter extends BaseAdapter{

    private LayoutInflater inflater;
    private List<String> list;
    private Context context;

    public SideSlipFanAdapter(Context context, List<String> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View closeView = null;
        if (convertView == null){
            convertView = inflater.inflate(R.layout.listview_fan_delete, parent, false);
