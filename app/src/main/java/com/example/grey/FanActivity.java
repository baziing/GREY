...
//        setSupportActionBar(toolbar);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent=new Intent(FanActivity.this,DrawerActivity.class);
    ...
    private void setListeners() {
        if (adapter != null){
            // 注册监听器,回调用来刷新数据显示
            adapter.setDelItemListener(new SideSlipFanAdapter.DeleteItem() {
                @Override
    ...
    private void setAdapter() {
        adapter = new SideSlipFanAdapter(this, list);
